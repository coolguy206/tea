...
module.exports = {
    ...
    landing: {
        src: ['landing-page/' + config.landing.name + '/dev/content.html', 'landing-page/' + config.landing.name + '/' + config.landing.date + '/js/babel/scripts.js'],
        css: ['landing-page/' + config.landing.name + '/css/styles.css'],
        dest: 'landing-page/' + config.landing.name + '/css/purify/styles.css'
    },
    ...
    promos: {
        src: ['promos/' + config.promo.name + '/dev/content.html', 'promos/' + config.promo.name + '/js/babel/scripts.js'],
        css: ['promos/' + config.promo.name + '/css/styles.css'],
        dest: 'promos/' + config.promo.name + '/css/purify/styles.css'
    },

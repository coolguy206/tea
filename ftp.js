...
var category = `promos/one-offs/2023/0120/v0/boy/`;
// var category = `homepage/2023/0110/v1/`;
...
//!NEEDS ENDING SLASH
var readFilePath = `Site/category-banners/boy/`;
var writeFilePath = `promos/headers/dev/images/boy/`;
var fileName = `c2b-m`;
var ext = `.jpg`;

...
var category = `promos/one-offs/2024/1013/v0/`;
// var category = `homepage/2024/1009/v0/`;
...
//!NEEDS ENDING SLASH
var readFilePath = `Site/1013/Site/headers/`;
// var readFilePath = `handoff/headers/0805/Category Headers & Visual Nav/Playwear/`;

// var writeFilePath = `promos/bubble/dev/images/`;
// var writeFilePath = `promos/default/dev/images/homepage/1013/`;
// var writeFilePath = `promos/default/dev/images/mega-menu/1013/`;
var writeFilePath = `promos/headers/dev/images/select-styles/`;
// var writeFilePath = `landing-page/sweeps/carry-in-style/dev/images/`;
// var writeFilePath = `homepage/default/dev/images/1009/`;

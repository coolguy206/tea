...
exports.digitalMarketingCoordinator = void 0;
var digitalMarketingCoordinator = {
  ...
  pay: "Pay Range:\n    $25 per hour USD",
  duties: ["Set up and monitor campaigns in Paid Social and Search Engine platforms", "Monitor digital marketing channels to deliver customer acquisition targets (number of customers and cost/customer)", "Track, measure and report digital marketing channels", "Gain experience working on programs across the entire marketing funnel from campaign set up, reporting and optimizations, all the way through the customer journey", "Support ad content development: Work with brand and creative team to conceptualize and create compelling ad content for core and emerging channels", "Proactively evaluate and recommend new marketing opportunities and technologies for driving customer acquisition"],
...
exports.digitalMarketingCoordinator = digitalMarketingCoordinator;
...
},{"./digital-marketing-coordinator.js":1,"./director-marketing.js":2}],5:[function(require,module,exports){
"use strict";

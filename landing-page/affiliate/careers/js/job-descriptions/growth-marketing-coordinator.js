export var growthMarketingCoordinator = {
    ...
    duties: [
        {
            ...
            list: [
                `Support the day-to-day execution of marketing campaigns across digital advertising and catalogs. Partner with Creative and cross-functional teams to ensure assets are planned, delivered, and launched accurately and on time.`
            ]
        },
        {
            header: `Channel & Partner Support:`,
            list: [
                `Coordinate with external partners such as advertising platform representatives and catalog vendors to ensure timelines, assets, and execution are aligned.`
            ]
        },

        {
            ...
            list: [
                `Support testing across creative, copy, and targeting strategies. Track results and help summarize learnings to inform future optimizations and improvements.`
            ]
        },

        {
            ...
            list: [
                `Pull and organize weekly, monthly, and quarterly performance data across marketing channels. Support reporting and hindsighting to help the team understand trends, pacing, and opportunities.`
            ]
        },

        {
            ...
            list: [
                `Help keep marketing calendars, trackers, timelines, and documentation organized and up to date. Support smooth collaboration across teams by ensuring clarity, alignment, and follow-through on campaign deliverables.`
            ]
        },

    ],
    who: [
        `Curious, organized, and excited to grow in the marketing space`,
        `A proactive problem-solver and clear communicator`,
        `Equally comfortable with both creative and analytical tasks`,
        `Detail-oriented with strong organizational skills`,
        `Thrive in fast-paced, collaborative environments`
    ],
    qualifications: [
        `0–2 years of experience in digital marketing, eCommerce, or a related role`,
        `Hands-on experience with paid media platforms (Meta Ads + Google Ads)`,
        `Proficient using Excel/Google Sheets for data tracking and reporting`,
        `Bachelor's degree in Marketing, Advertising, or related with a strong academic track record`,
    ],

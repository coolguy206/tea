export var SocialMediaContentIntern = {
...
<p>Tea Collection is seeking a Marketing Intern for a 3-month internship to join our team. In this role, you will be responsible for ideating & producing daily video content for our paid and organic channels, and will work closely with the Digital & Brand Marketing teams to ensure alignment with Tea voice & business objectives.</p>
    ...
    <p>This is a part-time position, 10-15 hours per week.</p>`,
        duties: [
                `Brainstorm video content based on current trends (sounds, challenges, etc.)`,
                `Align ideas with brand voice and featured product`,
                `Highlight & support on-site promos and product launches`,
                `Produce and edit 5 videos per week to be used on TikTok and/or Instagram`,
                `Report out on performance & creative learnings`
        ],
        qualifications: [

                `Currently a student or recent grad with interest in social media marketing`,
                `Creative, outgoing, curious mind with ability to brainstorm and iterate`,
                `Ability to work in a fast-paced environment`,
                `Strong communication skills, decisiveness, & attention to detail`,
                `Able to work independently with daily direction from key lead`,
                `Engagement in learning and research on social media platforms & trends`,
                `Previous experience creating content, portfolio a plus`,
                `Experience as a creator on TikTok is a plus`

...
$(document).ready(function () {
  ...
  if (url == '/black-friday') {
    console.log('black friday page'); //banner ctas
    ...
    $.each(subCats, function (i, val) {
      ...
      var str = $(val).text(); // console.log(`str`);
      // console.log(str);
    ...
    $.each(subCats, function (i, val) {
      ...
      var href = $(val).attr('href');
      var str = $(val).text();
      str = str.replace(/Styles/g, '').replace(/ /g, '').replace(/Girl/g, '').replace(/Boy/g, '').replace(/Baby/g, '').replace(/Newborn/g, '').replace(/Toddler/g, '').replace(/&Under/g, ''); // console.log(`str`);
      // console.log(str);

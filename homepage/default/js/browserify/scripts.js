...
$(document).ajaxComplete(function (event, xhr, options) {
  ...
  (0, _cloneExecuteSlider.cloneExecuteSlider)('.the-swim-slider', '.shop-slideshow-5');
...
$(document).ready(function () {
  ...
  (0, _inview.inview)('.hp .promo1-skinny, .hp .promo2-skinny, .hp .promo1, .hp .promo2, .hp .promo3, .hp .promo4, .hp .promos-2-cell, .hp .c1, .hp .c2, .hp .c2-slideshow, .hp .c3, .hp .c4, .hp .c5, .hp .c6, .hp .c7, .hp .c8, .hp .graphics, .hp .refer-friend, .hp .rewear, .hp .shop-slideshow, .hp .shop-slideshow2, .hp .shop-slideshow3, .hp .shop-slideshow4, .hp .shop-slideshow5, .hp .why-tea');
  for (var i = 1; i < 9; i++) {
  ...
  (0, _tracking.tracking)('.hp .shop-slideshow5 a', 'shop-slideshow5');

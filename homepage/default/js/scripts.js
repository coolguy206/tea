...
$(document).ready(function() {
  ...
  alt('.hp .c3 .second img', 'baby boy in leopard print tee');
  alt('.hp .c3 .second img', 'baby girl in pink dress');
  ...
  inview('.hp .promo1, .hp .promo2, .hp .c1, .hp .c2, .hp .c3, .hp .c4, .hp .c5, .hp .c6, .hp .c7, .hp .swim, .hp .graphics, .hp .new-arrivals, .hp .refer-friend, .hp .give-back');

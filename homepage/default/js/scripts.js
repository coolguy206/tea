...
$(document).ready(function() {
  ...
  alt('.hp .promo1 img', 'end of season sale take up to 70% off sale items');
  ...
  alt('.hp .c4 .first img', 'kids in clothes');
  alt('.hp .c4 .second img', 'girl in dress');
  alt('.hp .c4 .third img', 'girl in outfit');

...
export const switchSale = (href) => {
  ...
  switch (href) {
    ...
    case '/sale/girls-clothing/view-all':
      promo1 = urls.promo.clearance.girl;
    ...
    case '/sale/boys-clothing/view-all':
      promo1 = urls.promo.clearance.boy;
    ...
    case '/sale/baby-girl-clothes/view-all':
      promo1 = urls.promo.clearance.baby.girl;
    ...
    case '/sale/baby-boy-clothes/view-all':
      promo1 = urls.promo.clearance.baby.boy;
    ...
    case '/sale/toddler-girls-clothing/view-all':
      promo1 = urls.promo.clearance.toddler.girl;
    ...
    case '/sale/toddler-boys-clothing/view-all':
      promo1 = urls.promo.clearance.toddler.boy;
    ...
    case '/sale/newborn-clothing/view-all':
      promo1 = urls.promo.clearance.baby.newborn;

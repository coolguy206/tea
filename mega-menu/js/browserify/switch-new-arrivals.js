...
var switchNewArrivals = function switchNewArrivals(href) {
  ...
  switch (href) {
    case '/girls-clothing/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.girl;
    ...
    case '/boys-clothing/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.boy;
    ...
    case '/baby-girl-clothes/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.baby.girl;
    ...
    case '/baby-boy-clothes/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.baby.boy;
    ...
    case '/toddler-girls-clothes/favorites/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.toddler.girl;
    ...
    case '/toddler-boys-clothes/favorites/new-arrivals':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.toddler.boy;
    ...
    case '/newborn-clothes/':
      promo1 = _urls.urls.promo.promo; // promo1 = urls.promo.select.baby.newborn;

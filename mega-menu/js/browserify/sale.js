...
var switchNewArrivals = function switchNewArrivals(href) {
  ...
  switch (href) {
    ...
    case '/swim-shop':
      ...
      promo2 = _urls.urls.promo.select.family;
      clearance = _urls.urls.promo.clearance.girl; // $('.promo1-url.family').show();
      // $('.promo1-url, .promo2-url, .clearance-url').show();
      // $('.promo1-url').hide();
      // $('.promo2-url').hide();
      // $('.clearance-url').hide();
...
var switchSale = function switchSale(href) {
  ...
  switch (href) {
    ...
    case '/sale/newborn-clothing/view-all':
      ...
      clearance = _urls.urls.promo.clearance.baby.newborn; // $('.promo2-url').show();
      // $('.promo1-url, .promo2-url, .clearance-url').show();

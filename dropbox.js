...
refreshAccessToken((data) => {
  ...
  var folderPath = `/Sam Khieu’s files/Shared/Design/2024/Promotions/06 June/061724 Summer fun Price Points/04 Handoff/Site/nav/`;
  ...
  var writeFilePath = `Site/0617/nav/`;

...
refreshAccessToken((data) => {
  ...
  var folderPath = `/Sam Khieu’s files/Shared/Design/2024/Site/032624 Swim LP/Handoff/`;
  // var folderPath = `/Sam Khieu’s files/Shared/Design/2024/Campaign/031124 Green Sprouts/04 Handoff/Site/`
  folderPath = folderPath.toLowerCase();
  // console.log(folderPath);

  // var writeFilePath = `Site/0314/v2/`;
  var writeFilePath = `handoff/landing-pages/swim/0326/`;

...
refreshAccessToken((data) => {
  ...
  var folderPath = `/Sam Khieu’s files/Shared/Design/2024/Site/022724 Special Occasion LP/Handoff/`;
  ...
  var writeFilePath = `handoff/landing-pages/special-occasion/0227/`;
